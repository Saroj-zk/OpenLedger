...
import { MODELS, MODEL_TOTAL, PROVIDERS } from '../data/catalog';
...
export default function ModelsSection() {
  return (
    <Section id="models" index="03" label="Models" tint full>
      <SectionHead
        eyebrow="Models"
        title="Every model you already pay for."
        deck="Reason with one model, draft with another, and hand the routine work to the cheapest."
        meta={[
      ...
      <div className="mt-12 border-t border-[color:var(--color-border)]">
        <Reveal>
